...
| Media | `HasMedia` | `InteractsWithMedia` | in-other-worlds: Content, Product, Bundle. bianka: Product, Bundle |
...
| Taxonomy | `HasCategories`, `HasTags` | `InteractsWithCategories`, `InteractsWithTags` | in-other-worlds: Content, Product, Bundle. bianka: Product, Bundle |
